...
@section('content')
    ...
    <div class="content">
        ...
        <h2 class="content-heading">
            <i class="fa fa-angle-right text-muted mr-1"></i> Accommodations | Edit
        </h2>
        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" value="{{$accom->name}}" placeholder="Deluxe Room" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-sm-3 form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="rate" value="{{$accom->rate}}" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-sm-3 form-group">
                                <div class="input-group">
                                    ...
                                    <select name="rate_type" id="rate_type" class="form-control">
                                        <option value="Rupees" @if($accom->rate_type=='Rupees') selected @endif>Rupees</option>
                                        <option value="Dollor" @if($accom->rate_type=='Dollor') selected @endif>Dollor</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <textarea name="details"  id="js-ckeditor"  class="form-control">{{$accom->details}}</textarea>
                            </div>
