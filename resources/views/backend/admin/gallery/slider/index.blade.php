                                        ...
                                        <div class="col-sm-12">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    @if(request('order') || request('per_page'))
                                                        <br>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="p-1 border">
                                                <div class="row">
                                                    <div class="col-sm-12" style="height: 170px; overflow: hidden;">
                                                        <div class="options-container fx-item-zoom-in fx-overlay-zoom-out">
                                                            <img class="img-fluid options-item" src="{{asset('public/gallery'.'/'.$gallery->image)}}" alt="{{$admin->name}}">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="p-2 border">
                                                            <h6 class="text-dark font-size-sm border-bottom pb-1 mb-1">{{\Illuminate\Support\Str::limit($gallery->title,30)}}</h6>
                                                            <a class="badge badge-info img-lightbox" href="{{asset('public/gallery'.'/'.$gallery->image)}}">
                                                                <i class="fa fa-eye mr-1"></i> View
                                                            </a>
                                                            <a class="badge badge-success" data-toggle="modal" data-target="#editImages{{$gallery->id}}" href="javascript:void(0)">
                                                                <i class="fa fa-edit mr-1"></i> Edit
                                                            </a>
                                                            <a href="{{url()->current().'/'.$gallery->id.'/delete'}}" onclick="return confirm('Are you sure to delete this image?')" class="badge badge-danger">
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-popout" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header bg-primary">
                                                <h5 class="modal-title text-white">Edit Image Info</h5>
                                                ...
                                                <div class="block block-transparent block-rounded w-100 mb-0 overflow-hidden">
                                                    <div class="block-content block-content-full bg-white">
                                                        ...
                                                        <div class="text-center">
                                                            <p class="text-uppercase font-w700 font-size-sm text-muted">Edit Image Info</p>
                                                        </div>
                                                        <!-- END Header -->
                                                        ...
                                                        <form class="js-validation-signin" action="{{url()->current().'/'.$gallery->id.'/update'}}" method="POST" enctype="multipart/form-data">{{csrf_field()}}
                                                            ...
                                                            <div class="form-group text-center mb-0">
                                                                ...
                                                                <a href="{{url()->current().'/'.$gallery->id.'/delete'}}" class="btn btn-hero-danger">
                                                                    <i class="fa fa-fw fa-trash mr-1"></i> Delete Image
                                                                </a>
                                                            </div>
                                                        </form>
                                                    </div>
