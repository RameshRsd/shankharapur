...
@section('content')
    ...
    <div class="content">
        ...
        <h2 class="content-heading">
            <i class="fa fa-angle-right text-muted mr-1"></i> Location Management | Districts
        </h2>
        <div class="row">
                        ...
                        <form action="" method="get">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label for="">Filter District <i class="fa fa-search"></i></label>
                    ...
                    <div class="border p-2 bg-white">
                        <div class="table-responsive">
                            <div class="button-section mb-2 text-right">
                                <button class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#addDistrict"><i class="fa fa-plus-circle"></i> Add District</button>
                            </div>
                                ...
                                <tbody>
                                    @foreach($districts as $key=>$district)
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#editDistrict{{$district->id}}"><i class="fa fa-edit"></i></button>
                                            </td>
                                        </tr>
                                        <div class="modal fade" id="editDistrict{{$district->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-default-popout" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-popout" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-info">
                                                        <h5 class="modal-title text-white">Edit District</h5>
                                                        ...
                                                        <div class="block block-transparent block-rounded w-100 mb-0 overflow-hidden">
                                                            <div class="block-content block-content-full bg-white">
                                                                ...
                                                                <div class="text-center">
                                                                    <p class="text-uppercase font-w700 font-size-sm text-muted">Edit District</p>
                                                                </div>
                                                                <!-- END Header -->

                                                                <!-- For more info and examples you can check out https://github.com/jzaefferer/jquery-validation -->
                                                                <form class="js-validation-signin" action="{{url()->current().'/'.$district->id.'/update'}}" method="POST">{{csrf_field()}}
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            <div class="form-group">
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <select name="state_id" id="state_id_edit" class="form-control" required>
                                                                                        <option value="">--Choose--</option>
                                                                                        @foreach($states as $state)
                                    ...
                                    <tr>
                                        <th colspan="5">
                                            {{$districts->appends(['per_page'=>request('per_page')])->appends(['order'=>request('order')])->appends(['state_id'=>request('state_id')])->links()}}
                                        </th>
                                    </tr>
                                </tbody>
                            </table>
    ...
    <script>
        ...
        $('#country_id_edit').on('change', function(e){
            ...
            $.get('{{url('admin')}}/get_state?country_id=' + district_id,function(data) {
                console.log(data);
                $('#state_id_edit').empty();
                $('#state_id_edit').append('<option value="0" disable="true" selected="true">--Choose--</option>');
