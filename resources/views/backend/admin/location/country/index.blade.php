                    ...
                    <div class="border p-2 bg-white">
                        <div class="table-responsive">
                            <div class="button-section mb-2 text-right">
                                <button class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#addCountry"><i class="fa fa-plus-circle"></i> Add Country</button>
                            </div>
                                ...
                                <tbody>
                                    @foreach($countries as $key=>$country)
                                        <tr>
                                            ...
                                            <td>{{$country->name}}</td>
                                            <td>
                                                <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#editCountry{{$country->id}}"><i class="fa fa-edit"></i></button>
                                            </td>
                                        </tr>
                                        <div class="modal fade" id="editCountry{{$country->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-default-popout" aria-hidden="true">
                                                    ...
                                                    <div class="modal-body pb-1">
                                                        ...
                                                        <div class="block block-transparent block-rounded w-100 mb-0 overflow-hidden">
                                                            <div class="block-content block-content-full bg-white">
                                                                ...
                                                                <form class="js-validation-signin" action="{{url()->current().'/'.$country->id.'/update'}}" method="POST">{{csrf_field()}}
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            <div class="form-group">
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" id="example-group1-input1" name="name" value="{{$country->name}}" required>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
